 ...
 */
@Composable
fun <T : Any> ambientContainerHint(key: ContainerHintKey<T>): Effect<T> = effectOf {
  // Plus operator is lower precedence than get, this seems cleaner than wrapping with parentheses.
  val hints = +ambient(ContainerHintsAmbient)
  return@effectOf hints[key]
}
